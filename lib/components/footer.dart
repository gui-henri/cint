              ...
              child: Row(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: const Icon(Icons.explore_outlined, color: Colors.white, size: 38,), 
                  ),
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).pushNamed('/home');
                  ...
                  GestureDetector(
                    ...
                    child: const Icon(Icons.home_outlined, color: Colors.white, size: 38,), 
                  ),
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).pushNamed('/home');
                    },
                    child: const Icon(Icons.chat_outlined, color: Colors.white, size: 38,), 
                  ),
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).pushNamed('/home');
